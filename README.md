...
4. An alignment/visualization tool:
	- [ChimeraX](https://www.cgl.ucsf.edu/chimerax/download.html) 1.3.1
...
##### ChimeraX
[ChimeraX](https://www.cgl.ucsf.edu/chimerax/download.html) 1.3.1 is provided as .deb and .rpm packages for Debian- and RedHat-based Linux distributions. On Fedora, ChimeraX can be installed from the command line with the DNF package manager.
```Bash
